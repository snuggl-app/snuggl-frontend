...
const IssueHighlight: FC<IssueHighlightProps> = ({ slice }) => {
  return (
    <section
      ...
      id="#issue"
    >
      <div className="flex container max-w-6xl mx-auto p-24 bg-azure rounded-4xl gap-6 ">
        ...
        <div className="flex bg-white py-5 px-10 gap-2 justify-center items-center rounded-3xl flex-col shadow-xl">
